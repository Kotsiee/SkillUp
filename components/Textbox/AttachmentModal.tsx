...
export default function AttachmentModal({ closeBtn, modalRef, fileUploader }: AttachmentModalProps) {
  return (
    <div class="chat-input-additional hide" ref={modalRef} hidden tabIndex={0} onBlur={() => closeBtn.current?.click()}>
      <ul>
