...
import { Chat, User, Messages, Files } from '../../../lib/newtypes/index.ts';
  ...
  return (
    <div {...props}>
      <div class="container">
        ...
        {isToolbarOpen.value && <TextToolbar quillRef={quillRef} styles={styles} />}
          ...
          <div class="options">
            <ul>
              <li class={`advanced-text${isToolbarOpen.value ? ' show' : ''}`}>
                <button onClick={() => (isToolbarOpen.value = !isToolbarOpen.value)}>
