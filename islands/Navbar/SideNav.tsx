...
const navLinks = [
  { name: "Dashboard", path: "/dashboard", icon: Icons.Filter },
  { name: "Messages", path: "/messages", icon: Icons.Filter },
  { name: "Explore", path: "/explore", icon: Icons.Search },
  { name: "Projects", path: "/projects", icon: Icons.Filter },
  { name: "Files", path: "/files", icon: Icons.Filter },
  { name: "Teams", path: "/teams", icon: Icons.Filter },
];

export default function UserSideNav({ pageProps, isNavbarOpen }: { pageProps: PageProps; isNavbarOpen: Signal<boolean> }) {
