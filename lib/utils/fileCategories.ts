...
export const extensionCategories: ExtensionMap = {
  ...
  "doc": { category: "Document", application: "Microsoft Word", validMimeTypes: ["application/msword"] },
  "docx": { category: "Document", application: "Microsoft Word", validMimeTypes: ["application/vnd.openxmlformats-officedocument.wordprocessingml.document"] },
  "dot": { category: "Document", application: "Microsoft Word Template", validMimeTypes: ["application/msword"] },
  "dotx": { category: "Document", application: "Microsoft Word Template", validMimeTypes: ["application/vnd.openxmlformats-officedocument.wordprocessingml.template"] },
  ...
  "rtf": { category: "Document", application: "Rich Text Format", validMimeTypes: ["application/rtf"] },
  "odt": { category: "Document", application: "OpenDocument Text", validMimeTypes: ["application/vnd.oasis.opendocument.text"] },
  "fodt": { category: "Document", application: "Flat OpenDocument Text", validMimeTypes: ["application/vnd.oasis.opendocument.text-flat-xml"] },
  "wpd": { category: "Document", application: "WordPerfect Document", validMimeTypes: ["application/wordperfect"] },
  "wps": { category: "Document", application: "Microsoft Works Document", validMimeTypes: ["application/vnd.ms-works"] },
  ...
  // 📖 EBOOK FORMATS
  "epub": { category: "Document", application: "EPUB eBook", validMimeTypes: ["application/epub+zip"] },
  ...
  "djvu": { category: "Document", application: "DjVu Scanned Document", validMimeTypes: ["image/vnd.djvu"] },
  "xps": { category: "Document", application: "Microsoft XPS Document", validMimeTypes: ["application/vnd.ms-xpsdocument"] },
  "oxps": { category: "Document", application: "OpenXPS Document", validMimeTypes: ["application/oxps"] },

  // ✍️ HANDWRITTEN & NOTES FILES
  "one": { category: "Document", application: "Microsoft OneNote", validMimeTypes: ["application/msonenote"] },
  ...
  "xls": { category: "Spreadsheet", application: "Microsoft Excel", validMimeTypes: ["application/vnd.ms-excel"] },
  "xlsx": { category: "Spreadsheet", application: "Microsoft Excel", validMimeTypes: ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"] },
  "xlsm": { category: "Spreadsheet", application: "Microsoft Excel Macro-Enabled", validMimeTypes: ["application/vnd.ms-excel.sheet.macroEnabled.12"] },
  "xlsb": { category: "Spreadsheet", application: "Microsoft Excel Binary Workbook", validMimeTypes: ["application/vnd.ms-excel.sheet.binary.macroEnabled.12"] },
  "xlt": { category: "Spreadsheet", application: "Microsoft Excel Template", validMimeTypes: ["application/vnd.ms-excel"] },
  "xltx": { category: "Spreadsheet", application: "Microsoft Excel Template", validMimeTypes: ["application/vnd.openxmlformats-officedocument.spreadsheetml.template"] },

  // 🌍 OPEN DOCUMENT & FREE ALTERNATIVES
  "ods": { category: "Spreadsheet", application: "OpenDocument Spreadsheet", validMimeTypes: ["application/vnd.oasis.opendocument.spreadsheet"] },
  "ots": { category: "Spreadsheet", application: "OpenDocument Spreadsheet Template", validMimeTypes: ["application/vnd.oasis.opendocument.spreadsheet-template"] },
  "fods": { category: "Spreadsheet", application: "Flat OpenDocument Spreadsheet", validMimeTypes: ["application/vnd.oasis.opendocument.spreadsheet-flat-xml"] },

  // 📋 SIMPLE TABLE FORMATS
  "dif": { category: "Spreadsheet", application: "Data Interchange Format", validMimeTypes: ["application/x-dif"] },
  "slk": { category: "Spreadsheet", application: "Symbolic Link Format", validMimeTypes: ["application/vnd.ms-excel"] },
  ...
  "aac": { category: "Audio", application: "Advanced Audio Codec (AAC)", validMimeTypes: ["audio/aac"] },
  ...
  "wav": { category: "Audio", application: "Waveform Audio Format", validMimeTypes: ["audio/wav", "audio/x-wav"] },
  "flac": { category: "Audio", application: "Free Lossless Audio Codec", validMimeTypes: ["audio/flac"] },
  "alac": { category: "Audio", application: "Apple Lossless Audio Codec" },
  "wma": { category: "Audio", application: "Windows Media Audio", validMimeTypes: ["audio/x-ms-wma"] },
  "amr": { category: "Audio", application: "Adaptive Multi-Rate Audio", validMimeTypes: ["audio/amr"] },
  ...
  "m3u8": { category: "Audio", application: "M3U Extended Playlist", validMimeTypes: ["application/vnd.apple.mpegurl", "audio/m3u8"] },
  ...
  "aiff": { category: "Audio", application: "Audio Interchange File Format", validMimeTypes: ["audio/aiff"] },
  "aif": { category: "Audio", application: "Audio Interchange File Format", validMimeTypes: ["audio/x-aiff"] },
  ...
  "wmv": { category: "Video", application: "Windows Media Video", validMimeTypes: ["video/x-ms-wmv"] },
  "asf": { category: "Video", application: "Advanced Systems Format", validMimeTypes: ["video/x-ms-asf"] },
  ...
  "rm": { category: "Video", application: "RealMedia Video", validMimeTypes: ["application/vnd.rn-realmedia"] },
  ...
  "ico": { category: "Image", application: "Icon File", validMimeTypes: ["image/vnd.microsoft.icon"] },
  ...
  "heif": { category: "Image", application: "High Efficiency Image Format", validMimeTypes: ["image/heif"] },
  "heic": { category: "Image", application: "High Efficiency Image Codec", validMimeTypes: ["image/heic"] },
  ...
  "psd": { category: "Image", application: "Adobe Photoshop Document", validMimeTypes: ["image/vnd.adobe.photoshop"] },
  "xcf": { category: "Image", application: "GIMP Image Format" },
  "dds": { category: "Image", application: "DirectDraw Surface", validMimeTypes: ["image/vnd.ms-dds"] },
  ...
  "dcm": { category: "Medical", application: "DICOM Medical Image", validMimeTypes: ["application/dicom"] },
  ...
  // 🔑 EXECUTABLES
  "exe": { category: "Executable", application: "Windows Executable", validMimeTypes: ["application/x-msdownload"] },
  "msi": { category: "Executable", application: "Windows Installer", validMimeTypes: ["application/x-msi"] },
  "dmg": { category: "Executable", application: "Apple Disk Image", validMimeTypes: ["application/x-apple-diskimage"] },

  /*--------------------------------------------------------------------------------------------------------*/

  // 💻 CODE FILES
  "js": { category: "Code", application: "JavaScript", validMimeTypes: ["text/javascript", "application/javascript"] },
  ...
  "dae": { category: "3D", application: "COLLADA 3D Model Format", validMimeTypes: ["model/vnd.collada+xml"] },
  "gltf": { category: "3D", application: "GL Transmission Format", validMimeTypes: ["model/gltf+json"] },
  ...
  "iges": { category: "3D", application: "Initial Graphics Exchange Specification", validMimeTypes: ["model/iges"] },
  ...
  "gcode": { category: "3D", application: "G-Code CNC Instructions", validMimeTypes: ["text/x-gcode"] },
  ...
  "sqlite": { category: "Database", application: "SQLite Database File", validMimeTypes: ["application/vnd.sqlite3"] },
  "sqlite3": { category: "Database", application: "SQLite 3 Database File" },
  "db3": { category: "Database", application: "SQLite 3 Database File" },
  "mdb": { category: "Database", application: "Microsoft Access Database", validMimeTypes: ["application/x-msaccess"] },
  "accdb": { category: "Database", application: "Microsoft Access Database (2007+)", validMimeTypes: ["application/vnd.ms-access"] },
  ...
  "sql": { category: "Database", application: "Structured Query Language Script", validMimeTypes: ["application/sql"] },
  ...
  "csv": { category: "Data", application: "Comma-Separated Values File", validMimeTypes: ["text/csv"] },
  "tsv": { category: "Data", application: "Tab-Separated Values File", validMimeTypes: ["text/tab-separated-values"] },
  "psv": { category: "Data", application: "Pipe-Separated Values File" },
  "json": { category: "Data", application: "JavaScript Object Notation", validMimeTypes: ["application/json"] },
  "jsonl": { category: "Data", application: "JSON Lines File", validMimeTypes: ["application/jsonl"] },
  "xml": { category: "Data", application: "Extensible Markup Language", validMimeTypes: ["application/xml", "text/xml"] },
  "yaml": { category: "Data", application: "YAML Ain't Markup Language", validMimeTypes: ["application/x-yaml"] },
  "yml": { category: "Data", application: "YAML Ain't Markup Language", validMimeTypes: ["application/x-yaml"] },
  "rdf": { category: "Data", application: "Resource Description Framework", validMimeTypes: ["application/rdf+xml"] },
  ...
  "parquet": { category: "Data", application: "Apache Parquet Data Format", validMimeTypes: ["application/vnd.apache.parquet"] },
  ...
  "woff2": { category: "Font", application: "Web Open Font Format 2", validMimeTypes: ["font/woff2"] },
  "eot": { category: "Font", application: "Embedded OpenType Font", validMimeTypes: ["application/vnd.ms-fontobject"] },
  ...
  "svg": { category: "Vector", application: "Scalable Vector Graphics", validMimeTypes: ["image/svg+xml"] },
  "eps": { category: "Vector", application: "Encapsulated PostScript", validMimeTypes: ["application/postscript"] },
  "ai": { category: "Vector", application: "Adobe Illustrator File", validMimeTypes: ["application/postscript"] },
